...
function diagnostics.on_attach(_)
  ...
  nnoremap '<leader>dD'(get_diagnostics())(opts) 'Enlist all workspace diagnostics in quickfix'
  nnoremap '<leader>dd'(get_diagnostics(0))(opts) 'Enlist all workspace diagnostics in quickfix'
  nnoremap '<leader>dE'(workspace_errors)(opts) 'Enlist workspace error diagnostics in quickfix'
  nnoremap '<leader>dW'(workspace_warnings)(opts) 'Enlist workspace warning diagnostics in quickfix'
  nnoremap '<leader>dI'(workspace_infos)(opts) 'Enlist workspace info diagnostics in quickfix'
  nnoremap '<leader>dH'(workspace_hints)(opts) 'Enlist workspace hint diagnostics in quickfix'
  nnoremap '<leader>de'(document_errors)(opts) 'Enlist document error diagnostics in quickfix'
  nnoremap '<leader>dw'(document_warnings)(opts) 'Enlist document warning diagnostics in quickfix'
  nnoremap '<leader>di'(document_infos)(opts) 'Enlist document info diagnostics in quickfix'
  nnoremap '<leader>dh'(document_hints)(opts) 'Enlist document hint diagnostics in quickfix'
  nnoremap 'sd'(vim.diagnostic.open_float)(opts) 'Show current line diagnostics in a floating window'
