...
-- { 'EdvinVikstrom/filetree.nvim', config = "require('plugins.explorer').filetree()", },
-- { 'folke/lsp-trouble.nvim', after = 'nvim-lspconfig', config = "require('plugins.lsp').trouble()", disable = true, },
-- { 'simrat39/symbols-outline.nvim', config = function() vim.g.symbols_outline = { highlight_hovered_item = true, show_guides = true, auto_preview = false, -- experimental position = 'right', keymaps = { close = 'q', goto_location = '<Cr>', focus_location = 'o', hover_symbol = '<C-space>', rename_symbol = 'r', code_actions = 'a', }, lsp_blacklist = {}, } vim.api.nvim_set_keymap( 'n', '<M-s>', ':SymbolsOutline<CR>', { noremap = true, silent = true }) end, cmd = { 'SymbolsOutline' }, },
-- { 'nvim-lua/lsp_extensions.nvim', event = 'BufRead', disable = true },
-- { 'rhysd/conflict-marker.vim', config = function() vim.g.conflict_marker_begin = '^<<<<<<< .*$' vim.g.conflict_marker_common_ancestors = '^||||||| .*$' vim.g.conflict_marker_end = '^>>>>>>> .*$' vim.cmd [[ highlight link ConflictMarkerOurs DiagnosticVirtualTextHint highlight ConflictMarkerBegin guibg=#2f7366 highlight ConflictMarkerOurs guibg=#2e5049 highlight ConflictMarkerTheirs guibg=#344f69 highlight ConflictMarkerEnd guibg=#2f628e highlight ConflictMarkerCommonAncestorsHunk guibg=#754a81 ]] end, event = 'BufWinEnter', },
-- { 'Pocco81/HighStr.nvim', config = require('plugins.utilities').highlight, event = 'BufWinEnter', },
-- { 'rcarriga/nvim-notify', config = function() require 'plugins.nvim.notify' end, event = 'BufWinEnter', },
-- { 'folke/todo-comments.nvim', config = require('plugins.utilities').todo_comments, event = 'BufWinEnter', disable = true, },
-- { 'folke/twilight.nvim', config = require('plugins.utilities').twilight, cmd = { 'Twilight', 'TwilightEnable' }, disable = true, },
-- { 'folke/which-key.nvim', config = require('plugins.utilities').which_key, event = 'BufWinEnter', disable = true, },
-- { 'filipdutescu/renamer.nvim', branch = 'master', config = "require 'plugins.lsp'.renamer()", requires = { 'nvim-lua/plenary.nvim' }, after = 'nvim-lspconfig', },
