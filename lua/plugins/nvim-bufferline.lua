...
u.kmap('n', '<A-S-b>', '<CMD>BufferLineCyclePrev<CR>', ntst)
u.kmap('n', '<A-b>', '<CMD>BufferLineCycleNext<CR>', ntst)
u.kmap('n', '[b', '<CMD>BufferLineMovePrev<CR>', ntst)
u.kmap('n', ']b', '<CMD>BufferLineMoveNext<CR>', ntst)
u.kmap('n', '<leader>b', '<CMD>BufferLinePick<CR>', ntst)
u.kmap('n', '<leader>x', ':bd<CR>', ntst)

for i = 1, 9 do
  u.kmap('n', "<A-" .. i .. ">", '<CMD>BufferLineGoToBuffer' .. i .. '<CR>',
         ntst)
end
